...
<body class="container sm:w-full sm:h-[1024px] m-auto">
    <div class="container h-fit w-full sm:h-[960px] px-3 pt-[32px] flex flex-col space-y-[10px]">
        ...
        <!-- soal -->
        <div class="container flex-col justify-center sm:w-[1280px] sm:px-0 px-4 space-y-[10px] sm:space-x-[20px] flex sm:flex-row">
            <h1 class="text-2xl text-left flex sm:text-4xl sm:m-[10px] sm:w-full ">Lorem ipsum dolor sit amet pretium consectetur adipiscing elit.
            Lorem consectetur adipiscing elit
        </h1>
        </div>
        <!-- button jawaban -->
        <div class="flex flex-row sm:flex-col space-x-8 sm:space-x-0">
        <div class="container sm:w-[1280px] w-[142px] h-fit sm:h-[320px] flex flex-col sm:flex-row">
            <a href="#A">
        ...
        <!-- next/prev button -->
        <div class="container justify-end pr-[20px] sm:pr-0 sm:w-[1280px] sm:h-[104px] flex flex-row">
