                ...
                <div type="button" onclick="toggleModal('modal-'+{{$quiz->id}})"
                    ...
                    <div>
                        ...
                        <h1
                            ...
                            {{$quiz->quiztitle}}</h1>
                        <p
                            class="font-poppins sm:text-xl text-[12px] text-grey-fade flex flex-col font-light justify-start px-3 sm:px-7">
            ...
            <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
                ...
                <div id="card" class="container flex flex-col justify-start py-5 mx-6 z-10 w-full h-[400px] sm:w-[491px] sm:h-[654px]
                    ...
                    <div class="container mx-auto w-full px-6 h-full flex space-y-2 flex-col">
                        ...
                        <h1 class="flex self-start font-medium text-[16px] font-inter text-black sm:text-3xl ">
                            {{$quiz->quiztitle}}</h1>
                        <p class="text-[12px] flex flex-col font-poppins sm:text-2xl text-grey-fade self-start">
                            {{$quiz->quizdesc}}</p>
                    </div>
                    <!-- button masuk -->
