...
<body>
    <div class="justify-center flex m-auto my-[150px] w-full h-full">
        <div class="bg-white shadow-md border border-gray-200 rounded-lg sm:w-[491px] sm:h-[654px] p-4 sm:p-6 lg:p-8">
          ...
          border-gray-300 text-gray-900 text-xs sm:text-sm rounded-lg focus:ring-green-111 focus:border-green-111 block w-full p-2.5" required="">
            ...
            text-center">Login to your account</button>
                    ...
                    Not registered? <a href="/register"
                        class=" text-sm font-medium text-blue-700 hover:underline">Create account</a>
                </div>
            </form>
