                ...
                <div class="m-auto sm:w-[1280px] h-[676px] flex flex-col justify-start space-y-5">
                    ...
                    <div name="add" class="space-y-3 w-full sm:w-[630px]">
                        ...
                        <div class="flex flex-row">
                            <button class="" wire:click="addsoalpilgan">
                                <img class=" w-[60px] h-[60px] hover:scale-105" id="btnpilgan"
                                    src="{{ URL('pictures/Pilganda.png') }}"></button>
                            <button class="" href="">
                                <img class="w-[60px] h-[60px] hover:scale-105" src="{{ URL('pictures/essay.png') }}"
                                    alt="pilgan"></button>
                            <button class="" href="">
                                <img class="w-[60px] h-[60px] hover:scale-105" src="{{ URL('pictures/drag.png') }}"
                                    alt="pilgan"></button>
                        </div>
