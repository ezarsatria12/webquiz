...
@section('container')
    <section>
        <div class="container space-y-2 m-auto px-3 sm:px-0 sm:h-max">
            <div class="container sm:mx-10 h-fit space-y-5 justify-start flex my-auto lg:flex-row sm:space-y-0 sm:space-x-0">
                <div
            ...
            <div
                ...
                @foreach ($quizs as $quiz)
                        ...
                        rounded-[10px] bg-white">
                            <div class="w-full flex flex-col justify-center mx-auto">
                                ...
                                <div class="container mx-auto w-full px-6 text-center pb-5 h-auto flex space-y-2 flex-col">
                                    ...
                                    <button onclick="togglekonfirm('modal-id'+{{ $quiz->id }})"
                                        class="text-[12px] sm:text-[18px] mx-auto
                                sm:py-1 bg-red-redFF6767 font-inter text-black hover:scale-105 hover:text-white
                                rounded-[4px] sm:rounded-[6px] w-full"
                                        href="#">
                                        <span>Delete</span>
                                    </button>
                                </div>
                    ...
                    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
                        id="modal-{{ $quiz->id }}">
                        <div id="card"
                            class="container flex flex-col justify-start py-5 mx-6 z-10 w-full h-[400px] sm:w-[491px] sm:h-[654px]
                            ...
                            <div class="container mx-auto w-full px-6 text-center h-full flex flex-col justify-end gap-3">
                                ...
                                <div type="button" onclick="togglekonfirm('modal-id'+{{ $quiz->id }})">
                                    <button
                                        class="font-inter text-black text-[12px] sm:text-[18px] mx-auto sm:py-1 bg-red-redFF6767 hover:scale-105
                    ...
                    <div class="hidden overflow-x-hidden m-auto overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
                        ...
                        <div id="modal-id{{ $quiz->id }}"
                            class="container m-auto flex flex-col justify-start py-5 z-10 px-5 w-full h-fit sm:w-[800px]
