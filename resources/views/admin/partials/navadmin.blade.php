<nav class="top-0 w-full sm:sticky">
    <div class="px-8 py-6 flex w-full flex-row justify-between bg-white ">
        <!--nav button-->
        <div class="hidden sm:flex text-grey-fade m-auto ">
    ...
    <div class="sm:hidden">
        ...
        <!-- hamburger nav menu -->
        <!-- Button to close the overlay n avigation -->
        ...
        <form action="/login">
            @csrf 
            <button class="hidden bg-green-111 px-4 py-2 rounded font-inter font-medium text-white hover:shadow-lg">
                Sign In
            </button>
        </form>
        @endif
