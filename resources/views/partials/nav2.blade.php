<nav class="sticky top-0 w-screen">
    <div class="flex flex-row justify-between bg-white lg:px-20 lg:py-auto sm:px-2 sm:py-3">
        <!--logo-->
        <h3 class="text-3xl font-medium ">logo</h3>
        <!--nav button-->
        <div class="sm:flex  content-center text-grey-fade m-auto text-center">
