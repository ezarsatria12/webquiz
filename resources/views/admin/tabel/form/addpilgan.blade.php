            ...
            <div>
                <form action="quiz.pilgan.store" method="POST" enctype="multipart/form-data">
                    ...
                    <div name="pilgan" class="container m-auto white w-full space-y-5">
                        ...
                        <textarea required
                            class="outline-green-111 rounded border-2 p-2 w-full
                        ...
                        <div class="space-y-5 w-full">
                                ...
                                <label class="inline-flex items-center w-full">
                                    ...
                                    <span class="ml-2 w-[1280px]" name="jawaban">
                                        <textarea required
                                            class="outline-green-111 rounded
                                                border-2 p-2 w-[300px] sm:w-full border-gray-200 resize-none"
                                            name="answer" id="answer" rows="1" placeholder="Masukkan jawaban"></textarea>
                                    </span>
                                </label>
                            </div>
                            ...
                            <div>
                                <button
                                    class="hidden  sm:flex hover:scale-105 bg-green-111 hover:bg-white hover:text-green-111 px-4 py-2 rounded font-inter font-medium text-white hover:shadow-lg">
                                    Tambahkan Opsi
                                </button>
