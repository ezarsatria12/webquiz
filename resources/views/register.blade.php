...
<div class="justify-center flex m-auto my-[150px] w-full h-full">
	<div
		...
		<form class="space-y-2 sm:space-y-6" action="#">
			<h3 class="pb-[50px] text-xl font-medium text-center text-gray-900">Register</h3>
			<div>
        <!-- username -->
				<label for="name" class="text-xs sm:text-sm font-medium text-gray-900 block mb-2">Your Name</label>
        ...
        w-full p-2.5" placeholder="Example@email.com" required="">
          ...
          <!-- pass -->
					...
					<input type="password" name="password" id="password" placeholder="Password"class="bg-gray-50 border outline-green-111
