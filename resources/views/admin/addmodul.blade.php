...
<section>
    ...
    <div class="container resize-none m-auto w-1440px] h-[1024px] space-y-20">
        <div class="container m-auto w-[1280px] h-[64px] flex flex-row justify-start space-x-20">
            <div name="Title" class=" w-[630px] space-y-3">
                ...
                <textarea required class="outline-green-111 rounded border-2 p-2 border-gray-200 resize-none" name="moduletitle" id="moduletitle" cols="80" rows="2" 
                placeholder="Masukkan Judul Modul" autofocus required value="{{ old ('moduletitle') }}"></textarea>
            </div>
    </div>
    <div class="m-auto w-[1280px] h-[676px] flex flex-col justify-start space-y-10">
        <div name="Title" class="space-y-3">
                ...
                <textarea class="outline-green-111 rounded border-2 p-2 border-gray-200 resize-none" name="moduledesc" id="moduledesc" cols="80" rows="6" 
                placeholder="Masukkan Judul Modul" autofocus required value="{{ old ('moduledesc') }}"></textarea>
        </div>
        <div name="add" class="space-y-3">
               <input type="file" class="form-control-file" id="media" name="media" autofocus required value="{{ old ('media') }}" onchange="previewImage()">
        </div>
