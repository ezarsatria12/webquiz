...
<section>
    ...
    <div class="container h-fit space-x-3 justify-start flex m-auto sm:w-[1280px] lg:flex-row sm:space-y-0 sm:space-x-5">
            ...
            <div type="button" onclick="toggleModal('modal-id')" class="container w-[150px] m-auto flex flex-col justify-start h-fit sm:w-[400px] sm:h-[430px] shadow-card rounded-[10px] bg-white">
                    ...
                    <h1 class="flex justify-start px-3 sm:px-7 text-[16px] sm:text-3xl ">{{ $modul->moduletitle}}</h1>
                    <p class="text-[12px] sm:text-[20px] flex flex-col  justify-start px-3 sm:px-7">{{ $modul->moduledesc}}</p>
                    </div>
