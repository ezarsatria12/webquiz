...
<body class="container bg-black sm:bg-gray-800 sm:w-full sm:h-full m-auto sm:gap-10">
        ...
        <div class="hidden sm:block w-full mx-auto bg-gray-400 px-14 my-20 flex-col gap-5">
            ...
            <div class="flex flex-row justify-between w-full h-fit gap-5">
                <div class="flex flex-row my-auto gap-5">
                    ...
                    <!-- video slider -->
                    <input class="hidden" type="range" id="slider" min="0" max="100" value="0" step="1"
                        oninput="Setvideo(this.value)" onchange="Setvideo(this.value)">
                    <!-- duration -->
    ...
    <div class="hidden sm:block w-full mx-auto px-14 my-20 flex-col gap-5">
        <img class="rounded-[10px] mx-auto h-fit w-fit " src="{{ asset('storage/' . $modules->media) }}" alt="asd"
            type="image">
    </div>
    <div
        class="hidden sm:block w-full mx-auto h-fit rounded-[10px] justify-center pb-20 pt-5  bg-gray-400 px-20 my-20 flex-col gap-5">
        <p class="text-xl  font-poppins  text-white">{{ $modules->moduledescimg }}</p>
    </div>
